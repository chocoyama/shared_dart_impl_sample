...
class HostAPI {
  ...
  Future<String> ping() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.shared_dart_impl_sample.HostAPI.ping', codec,
...
abstract class FlutterAPI {
  ...
  static void setup(FlutterAPI? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.shared_dart_impl_sample.FlutterAPI.ping', codec,
